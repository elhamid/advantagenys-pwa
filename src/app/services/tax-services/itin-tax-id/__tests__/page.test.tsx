...
describe("ItinTaxIdPage", () => {
  it("exports ITIN metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the ITIN hero, FAQ block, and appointment CTA", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /itin \/ tax id services/i })).toBeInTheDocument();
