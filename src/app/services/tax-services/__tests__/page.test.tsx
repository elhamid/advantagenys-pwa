...
describe("TaxServicesPage", () => {
  it("exports tax services metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the tax services hero and FAQ block", async () => {
    render(await Page());

    expect(
      screen.getByRole("heading", { name: /tax preparation and compliance for individuals and businesses/i })
    ).toBeInTheDocument();
