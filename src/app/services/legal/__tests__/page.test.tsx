...
describe("LegalServicesPage", () => {
  it("exports legal services metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the legal services hero and FAQ block", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /legal support for immigrant entrepreneurs and families/i })).toBeInTheDocument();
