...
describe("LicensingPage", () => {
  it("exports licensing metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the licensing hero and FAQ block", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /we navigate the licensing maze so you do not have to/i })).toBeInTheDocument();
