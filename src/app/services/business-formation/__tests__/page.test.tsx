...
describe("BusinessFormationPage", () => {
  it("exports business formation metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the business formation hero and FAQ block", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /start your business the right way/i })).toBeInTheDocument();
