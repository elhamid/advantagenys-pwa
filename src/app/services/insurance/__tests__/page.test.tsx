...
describe("InsurancePage", () => {
  it("exports insurance metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the insurance hero and FAQ block", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /business insurance that protects what you have built/i })).toBeInTheDocument();
