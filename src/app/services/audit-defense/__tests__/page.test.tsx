...
describe("AuditDefensePage", () => {
  it("exports audit defense metadata", () => {
    expect(metadata.title).toBeTruthy();
  });

  it("renders the audit defense hero and FAQ block", async () => {
    render(await Page());

    expect(screen.getByRole("heading", { name: /audit defense and fine reduction/i })).toBeInTheDocument();
