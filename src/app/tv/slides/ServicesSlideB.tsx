...
const FEATURED = [
  { key: "Insurance", Icon: ShieldIcon, bullets: ["General liability", "Workers compensation", "Disability insurance"] },
  { key: "Audit Defense", Icon: ScaleIcon, bullets: ["Workers comp audits", "Sales tax audits", "Fine reduction services"] },
  { key: "Financial Services", Icon: ChartIcon, bullets: ["Bookkeeping", "Financial statements", "Business analysis"] },
];

export default function ServicesSlideB({ cycleCount: _c }: { cycleCount: number }) {
  return (
    <SlideShell>
