...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body style={{ background: "#0F1B2D", color: "#fff", fontFamily: "system-ui, sans-serif", margin: 0, padding: "40px 20px", minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center" }}>
