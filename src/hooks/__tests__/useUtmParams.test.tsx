...
describe("useUtmParams", () => {
  ...
  it("captures form send ids without storing them as UTM", () => {
    setUrl("utm_source=advantageos&send_id=send-abc&form_send_id=ignored");
    ...
    expect(sendIdResult.current).toBe("send-abc");
  });
});
