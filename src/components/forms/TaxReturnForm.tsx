      ...
      <div className="flex gap-6">
        {yesNoOptions.map((opt) => (
          <label key={opt} className="flex items-center gap-2 cursor-pointer text-sm text-[var(--text-secondary)]">
            <input type="radio" name={name} value={opt} checked={formData[field] === opt} onChange={update(field)} className="text-[var(--blue-accent)] focus:ring-[var(--blue-accent)]" />
            {opt}
          </label>
        ))}
      </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={formData.filingYear} onChange={update("filingYear")} placeholder="e.g. 2025" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">
                  Filing Status <span className="text-red-500">*</span>
                </label>
                <select required value={formData.filingStatus} onChange={update("filingStatus")} className={inputClasses}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required value={formData.firstName} onChange={update("firstName")} placeholder="First name" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">
                  Last Name <span className="text-red-500">*</span>
                </label>
                <input type="text" required value={formData.lastName} onChange={update("lastName")} placeholder="Last name" className={inputClasses} />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required value={formData.socialSecurity} onChange={update("socialSecurity")} placeholder="Input only numbers (999223333)" maxLength={9} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">
                  Occupation <span className="text-red-500">*</span>
                </label>
                <input type="text" required value={formData.occupation} onChange={update("occupation")} className={inputClasses} />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="date" required value={formData.dateOfBirth} onChange={update("dateOfBirth")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">
                  Email <span className="text-red-500">*</span>
                </label>
                <input type="email" required value={formData.email} onChange={update("email")} placeholder="you@example.com" className={inputClasses} />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-[var(--text)] mb-1">
              ...
              <input type="tel" required value={formData.phone} onChange={update("phone")} placeholder="(929) 000-0000" className={inputClasses} />
            </div>

            {sectionTitle("Address")}
            <input type="text" required value={formData.addressStreet} onChange={update("addressStreet")} placeholder="Street address" className={inputClasses} />
            <input type="text" value={formData.addressStreet2} onChange={update("addressStreet2")} placeholder="Apt #" className={inputClasses} />
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <input type="text" required value={formData.addressCity} onChange={update("addressCity")} placeholder="City" className={inputClasses} />
              <input type="text" required value={formData.addressState} onChange={update("addressState")} placeholder="State" className={inputClasses} />
              <input type="text" required value={formData.addressZip} onChange={update("addressZip")} placeholder="ZIP Code" className={inputClasses} />
            </div>
            ...
            {showSpouse && (
              <>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <input type="text" value={formData.spouseFirstName} onChange={update("spouseFirstName")} placeholder="Spouse first name" className={inputClasses} />
                  <input type="text" value={formData.spouseLastName} onChange={update("spouseLastName")} placeholder="Spouse last name" className={inputClasses} />
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1">Spouse SSN</label>
                    <input type="text" value={formData.spouseSocialSecurity} onChange={update("spouseSocialSecurity")} placeholder="Input only numbers" maxLength={9} className={inputClasses} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1">Spouse Occupation</label>
                    <input type="text" value={formData.spouseOccupation} onChange={update("spouseOccupation")} className={inputClasses} />
                  </div>
                </div>
                <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1">Spouse DOB</label>
                    <input type="date" value={formData.spouseDateOfBirth} onChange={update("spouseDateOfBirth")} className={inputClasses} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1">Spouse Email</label>
                    <input type="email" value={formData.spouseEmail} onChange={update("spouseEmail")} className={inputClasses} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[var(--text)] mb-1">Spouse Phone</label>
                    <input type="tel" value={formData.spousePhone} onChange={update("spousePhone")} className={inputClasses} />
                  </div>
                </div>
              </>
            )}
          ...
          <>
            ...
            {formData.hasDependents === "Yes" && (
              <div>
                ...
                <textarea rows={4} value={formData.dependentsInfo} onChange={update("dependentsInfo")} placeholder="Child 1: John Doe, 01/15/2010, 123-45-6789, Son, 12 months&#10;Child 2: ..." className={inputClasses} />
              </div>
            )}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={formData.childcareProviderName} onChange={update("childcareProviderName")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Amount Paid</label>
                <input type="text" value={formData.childcareAmountPaid} onChange={update("childcareAmountPaid")} placeholder="$" className={inputClasses} />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Address of Provider</label>
                <input type="text" value={formData.childcareProviderAddress} onChange={update("childcareProviderAddress")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">SSN or EIN of Provider</label>
                <input type="text" value={formData.childcareProviderSSNOrEIN} onChange={update("childcareProviderSSNOrEIN")} className={inputClasses} />
              </div>
            </div>
            ...
            <div>
              ...
              <textarea rows={2} value={formData.eicAdditionalNote} onChange={update("eicAdditionalNote")} className={inputClasses} />
            </div>
          </>
        )}
        ...
        {step === 3 && (
          <>
            ...
            <div>
              ...
              <input type="text" value={formData.collegeExpenses} onChange={update("collegeExpenses")} placeholder="$" className={inputClasses} />
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={formData.businessName} onChange={update("businessName")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Business Tax ID (EIN)</label>
                <input type="text" value={formData.businessEIN} onChange={update("businessEIN")} className={inputClasses} />
              </div>
            </div>
            <div>
              <label className="block text-sm font-medium text-[var(--text)] mb-1">Business Address</label>
              <input type="text" value={formData.businessAddress} onChange={update("businessAddress")} className={inputClasses} />
            </div>
            <div>
              <label className="block text-sm font-medium text-[var(--text)] mb-1">Total Sales or Revenue</label>
              <input type="text" value={formData.totalSalesOrRevenue} onChange={update("totalSalesOrRevenue")} placeholder="$" className={inputClasses} />
            </div>
            <div>
              ...
              <div className="flex flex-wrap gap-4">
                {businessTypeOptions.map((opt) => (
                  <label key={opt} className="flex items-center gap-2 cursor-pointer text-sm text-[var(--text-secondary)]">
                    <input type="radio" name="businessType" value={opt} checked={formData.businessType === opt} onChange={update("businessType")} className="text-[var(--blue-accent)] focus:ring-[var(--blue-accent)]" />
                    {opt}
                  </label>
                ))}
              </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input type="text" value={formData.businessMiles} onChange={update("businessMiles")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Personal Miles</label>
                <input type="text" value={formData.personalMiles} onChange={update("personalMiles")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Total Miles</label>
                <input type="text" value={formData.totalMiles} onChange={update("totalMiles")} className={inputClasses} />
              </div>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                ...
                <input type="text" value={formData.mortgagePremiumInsurance} onChange={update("mortgagePremiumInsurance")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Mortgage Interest</label>
                <input type="text" value={formData.mortgageInterest} onChange={update("mortgageInterest")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Real Estate Taxes</label>
                <input type="text" value={formData.realEstateTaxes} onChange={update("realEstateTaxes")} placeholder="$" className={inputClasses} />
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" value={formData.medicalInsurance} onChange={update("medicalInsurance")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Doctors Co-Pays</label>
                <input type="text" value={formData.doctorsCoPays} onChange={update("doctorsCoPays")} placeholder="$" className={inputClasses} />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Prescriptions</label>
                <input type="text" value={formData.prescriptions} onChange={update("prescriptions")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Eyeglasses / Contacts</label>
                <input type="text" value={formData.eyeglassesContacts} onChange={update("eyeglassesContacts")} placeholder="$" className={inputClasses} />
              </div>
            </div>
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Medical Supplies</label>
                <input type="text" value={formData.medicalSupplies} onChange={update("medicalSupplies")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Medical Travel</label>
                <input type="text" value={formData.medicalTravel} onChange={update("medicalTravel")} placeholder="$" className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">Other Medical Expenses</label>
                <input type="text" value={formData.otherMedicalExpenses} onChange={update("otherMedicalExpenses")} placeholder="$" className={inputClasses} />
              </div>
            </div>
          </>
        )}
          ...
          <>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                ...
                <input type="text" required value={formData.bankRoutingNumber} onChange={update("bankRoutingNumber")} className={inputClasses} />
              </div>
              <div>
                <label className="block text-sm font-medium text-[var(--text)] mb-1">
                  Bank Account # <span className="text-red-500">*</span>
                </label>
                <input type="text" required value={formData.bankAccountNumber} onChange={update("bankAccountNumber")} className={inputClasses} />
              </div>
            </div>
