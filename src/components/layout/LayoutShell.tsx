...
export function LayoutShell({ children }: { children: React.ReactNode }) {
  ...
  // Chromeless routes (Samsung TV, kiosks) need a bare wrapper without
  // Tailwind arbitrary-value classes — restricted browsers cannot parse
  // pb-[calc(...)] / md:pb-0 / Tailwind v4 modern CSS.
  if (hideChrome) {
    return <>{children}</>;
  }
